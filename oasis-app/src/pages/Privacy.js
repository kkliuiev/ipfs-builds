  ...
  <MarketingLayout>
    <LegalTextLayout>
      ...
      <p>
        ...
        collected from the users of the website This App.app and other websites
        which use subdomains of This App.app(the "Site").This Privacy Policy
        also includes the Cookie We are committed to protecting and respecting
        your privacy.Please read this carefully as this Privacy Policy is
        legally binding when you use the Site.{' '}
      </p>{' '}
      <p>
      ...
      <p>
        ...
        difficulties our visitors may experience in accessing the SIte.With this
      ...
      <p>
        ...
        actions and patterns, and does not personally identify
        individuals(however, see below information on Ethereum wallet
        addresses).This information may include:
      </p>{' '}
      <ul>
      ...
      <p>
        ...
        providers will be used to assist us in better understanding our visitors
        ' interests in our Site and how to better serve those interests, as well
        as help ensure secure use of the website for all users.If you want to
      ...
      <p>
        ...
        order to improve our product user experience.We do not use this data for
        any purpose at an individual user level.{' '}
      </p>{' '}
      <p>
      ...
      <p>
        ...
        <a href="mailto:legal@This App.app"> legal @This App.app </a>. We use
        the data that you provide in an email to us, which you may give
        voluntarily, only in order to answer your contact question or to reply
        to your email in the best possible manner.{' '}
      </p>{' '}
      <h2> Your rights </h2> <h3> Right to access </h3>{' '}
      <p>
      ...
      <p>
        Please note that any data transmission on the Internet(e.g.communication
        by email) is generally not secure and we accept no liability for data
        transmitted to us via the Internet.Unfortunately, absolute protection is
        not technically possible.This information does not apply to the websites
        of third parties and the corresponding links given on the Site.We assume
        no responsibility and liability for these.{' '}
      </p>{' '}
      ...
      <p>
        ...
        version.The current version of the Privacy Policy, as published on the
        Site, is applicable.{' '}
      </p>{' '}
      <h2> Contact </h2>{' '}
      <p>
