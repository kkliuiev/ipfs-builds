export default {
    ...
    landing_page: {
        headline: 'Borrow and save using Dai',
        trade_card: {
            title: 'Trade',
            description: 'Place orders in the Marketplace, exchange your tokens, or Multiply your assets, quickly.',
        ...
        save_card: {
            title: 'Save',
            description: 'Earn savings on your Dai by locking it into This App Save. Automatic and non-custodial.',
            button: 'Save Dai'
        },
        token_section_title: 'Supported Tokens',
        token_section_only_on_trade: 'Only available on This App Trade',
        section1_title: 'What is This App?',
        section1_p: 'This App is a platform for decentralized finance. Use it to exchange tokens, borrow Dai and earn savings — all in one place.',
        section2_title: 'Secure protocol built on Ethereum',
        section2_p: 'This App is built on top of audited and formally verified smart contracts created by Maker, the industry leader in secure decentralized finance.',
        section3_title: 'Completely permissionless',
        section3_p: 'You—and only you—control your assets. This App is a decentralized, non-custodial platform, accessible using an Ethereum-supported wallet.',
        questions_title: 'Questions',
        question1: 'What is This App?',
        answer1: 'This App is a decentralized application that runs on the Ethereum blockchain. Anyone can use This App to trade tokens, borrow against them, and earn savings using Dai.',
        ...
        answer3: 'You do not need an account to use This App. However, you will need an Ethereum wallet. This App supports most Ethereum browser wallets such as {0}, {1}, etc.',
        ...
        question4: 'Is This App secure?',
        answer4: 'Security is our top priority. The This App team regularly conducts audits on our smart contracts. In addition, the This App code is {0}, giving the community the ability to pressure test and audit the core technology.',
        answer4_link1_url: 'https://github.com/This AppDEX',
        answer4_link1_text: 'open-source',
        question5: 'Will I be charged a fee to use This App?',
        answer5: 'This App is free to use. However, you will have to pay gas and other fees associated with the Maker Protocol, such as Stability Fees.',
        question6: 'How can I contact the This App team?',
        answer6: 'You can reach the This App team by contacting us on {0}.',
        answer6_link1_url: 'https://chat.makerdao.com',
        answer6_link1_text: 'chat',
        question7: 'Can I buy Bitcoin or Ethereum on This App using a credit card or via my bank account?',
        answer7: 'You cannot buy crypto from your bank account using This App. Instead, you can use Dai to buy Ethereum and other supported tokens.',
        read_only: 'Read-Only',
        wallet_connect: 'Wallet Connect',
        wallet_link: 'Coinbase Wallet'
    },
    borrow_landing: {
        page_name: 'This App Borrow',
        ...
        questions: {
            ...
            answer4: "If you don't have any of the supported collateral types, then you cannot use This App Borrow to generate Dai. You can still get Dai, but you would need to use an exchange to trade your collateral for Dai. You can check This App Trade which supports more collateral types.",
            ...
            bottom_link1: 'Full list of This App Vault FAQs',
    ...
    borrow_wbtc_landing: {
        ...
        step5_link_text: 'This App.app/borrow'
    },
    save_landing: {
        page_name: 'This App Save',
        ...
        quotes_block: {
            ...
            body: 'This App Save helps you stay patient while waiting out volatile market conditions, allowing you to confidently capture steady, predictable earnings.',
            quote1: 'When there was too much risk and volatility in the markets I decided to trade for DAI and deposit it in This App Save. It gave me peace of mind because I knew what my return would be, no more sleepless nights worrying about flash crashes',
            author1: 'This App Save User'
        },
        ...
        feature1_content: 'Manage your savings from anywhere, at anytime. This App is a decentralized application meaning that you are the only person that controls it.',
        ...
        feature4_content: 'This App regularly undergoes security audits and checks. Built by the developers of the MakerDAO protocol.',
        questions: {
            ...
            answer4: "No. Providing you don't share your wallet or private key with anyone else, only you are able to control and access the Dai deposited into This App Save. For this reason, it is also very important to backup your wallet, as there is no way to return your Dai if you lose access to your wallet.",
            ...
            bottom_link1: 'Full list of This App Save FAQs'
        }
    },
    trade_landing: {
        page_name: 'This App Trade',
        headline: 'Peer to peer crypto trading',
        subheadline: 'This App Trade is a decentralized, zero-fee token exchange with limit order support and quick token swap.',
        cta_button: 'Open This App Trade',
        quotes_block: {
            title: 'Place orders at the price you set',
            body: 'This App Trade allows you to create orders where you set the Price. Using either Limit Orders or Average Price Fill or Kill, you set the price and slippage limit so you know you won’t pay more than you expect.',
            quote1: "When I am looking to make trades, I always come back to This App because I know it's where I can get the best price. Not to mention not having to deal with all the hassles of the legacy financial system., wiring funds back and forth from place to place.",
            author1: 'This App Trade User '
        },
        ...
        feature2_content: 'A simple interface that allows you to open and manage your Multiplied Position with direct access to the This App Market.',
        feature3_heading: 'Quickly swap tokens',
        feature3_content: 'This App Trade permits you to get in and out of positions quickly, for a price you select and you only pay Gas Fees.',
        feature4_heading: 'Non-custodial',
        feature4_content: 'This App never touches or handles your tokens as all trades are settled within the contract. You are always in control of your funds.',
        questions: {
            question1: 'Do I have to pay any fees for using This App Trade?',
            answer1: "The only fee's that apply to This App Trade are fees for Gas. These are the fees you pay to use and interact with the Ethereum Blockchain. These fee's vary based on how busy the Ethereum network is, and how quickly you would like transaction to be processed.",
            question2: 'Can I buy cryptocurrency with my debit or credit card?',
            answer2: 'This App Trade only allows you to trade selected Ethereum tokens, such as Dai, ETH, USDC and more. There is no way to buy crypto using a debit or credit card using This App Trade.',
    ...
    cdp_create: {
        ...
        setup_proxy_allowance_text: 'This permission allows This App to interact with your {0}. This has to be done once for each new collateral type.',
        ...
        collateralization_warning: 'The amount of Dai you are generating is putting your Vault at risk of liquidation',
        ...
        liquidation_penalty_description: 'This is the additional fee that you will pay on top of your debt when your position is liquidated. There could also be other costs involved depending on the price your collateral is sold',
        ...
        proxy_failure_contract_data_info: 'If you see this message and are using a Ledger hardware wallet, it often means that you need to enable "Contract Data." To do this, go to your Ethereum app on Ledger, choose Settings and then Contract Data.',
    ...
    dsr_deposit: {
        ...
        open_vault: 'Earn savings on your Dai by locking into This App Save',
    ...
    save: {
        ...
        no_savings: "This address either doesn't exist or has no DSR account history"
    },
    verbs: {
    ...
    notifications: {
        ...
        non_vault_owner: 'The owner of this position ({0}) does not match the connected wallet address',
        non_overview_owner: 'You are currently viewing the Overview of another address ({0})',
        non_savings_owner: 'You are currently viewing the savings of another address ({0})',
        emergency_shutdown_active: 'Emergency shutdown has been initiated on {0}. This dashboard is currently read-only. If you have any vaults or DAI, please go to {1}. For more information you can read more {2}',
        vault_below_next_price: 'Your {0} Vault has entered the liquidation phase and your collateral will be auctioned at {1}. You can still avoid auction by depositing at least {2} or repaying {3}',
        vault_below_current_price: 'Your {0} Vault is available for liquidation and your collateral can be auctioned at any time. You can try to avoid the auction by depositing at least {1} or repaying {2}',
        vault_is_liquidated: 'Your Vault was recently liquidated and {0} was made available for Auction. Please check back here for more details.'
    }
};